        ...
        <div class="logo">
            <ul class="menu">
                ...
                <li class="categorie" ><a>Catégories</a>
                    ...
                    <ul class="sous_cat">
                       <li> <a href="electronique.php">Électroniques</a></li> <!-- Sous-catégorie Électroniques -->
...
.content{
    background-image: url(https://images.pexels.com/photos/52518/jeans-pants-blue-shop-52518.jpeg?auto=compress&cs=tinysrgb&w=600);
